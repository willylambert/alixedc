<?php
  ...
  $basePath = "/var/lib/alix/demo/files";
  ...
  $configEtude["IMPORT_BASE_PATH"] = "$basePath/$moduleName/import/";
  ...
  $configEtude["ODM_1_3_SCHEMA"] = "/var/www/bdlifes-extra.net/docs/alix/demo/$moduleName/xsd/ODM1-3-0-foundation.xsd";
  $configEtude["ODM_1_2_SCHEMA"] = "/var/www/bdlifes-extra.net/docs/alix/demo/$moduleName/xsd/ODM1-2-1-foundation.xsd";
  $configEtude["XQUERY_LIB"][] = "/var/www/bdlifes-extra.net/docs/alix/demo/$moduleName/xquery/alix.xqlib";
 ...
 //Security                                                
  ...
  $configEtude['PASSWORD']['UPPER_LOWER_CASE'] = false;
  $configEtude['PASSWORD']['CHANGE_AFTER'] = 900;
