...
class CMailFile {
    ...
    var $smtp_headers;
    var $empty_msg; //boolean, true if mail body is empty
    ...
    function attach_file($filename,$mimetype,$mime_filename) {
        ...
        $out = $out . "Content-type: " . $mimetype . "; name=\"$filename\"; charset=\"iso-8859-1\"\n";      
