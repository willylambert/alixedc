...
var pathToImages = 'alixedc/custom/1.0.0/img/';	// Relative to your HTML file
...
function pickDate(e,inputDay)
{
	...
	if(returnFormat){
	 ...
	 alert('toto');
	  ...
	  returnDateToMonth.value = parseFloat(month);
	  returnDateToDay.value = parseFloat(day);
	  if(calendarDisplayTime){
      returnDateToHour.value = parseFloat(currentHour);
	    returnDateToMinute.value = parseFloat(currentMinute);
	  }
	}
	closeCalendar();
