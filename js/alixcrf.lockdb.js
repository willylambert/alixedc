...
/*
LockDB Edit Entry point - called to initalize the JavaScript
*/
function loadAlixCRFlockeditJS(CurrentApp)
{
  jQuery(document).ready(function(){
    ...
    $('#btnCancel')
			.button()
			.click(function() {
        document.location = "index.php?menuaction=" + CurrentApp + ".uietude.lockdbInterface";
	  });
...
*/
function loadAlixCRFlockJS(CurrentApp)
{                   
	$('#btnAddLockDB').button();
